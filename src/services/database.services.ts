...
// const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@twitter.izrzjtb.mongodb.net/?retryWrites=true&w=majority&appName=twitter`
const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0.i2cpalb.mongodb.net/?retryWrites=true&w=majority`
